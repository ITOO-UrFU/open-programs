...
urlpatterns.append(url(r'^api/v11/get_trajectory_id/$', get_trajectory_id, name="get_trajectory"))
urlpatterns.append(url(r'^api/v11/get_trajectory_link/$', get_trajectory_link, name="get_link"))
