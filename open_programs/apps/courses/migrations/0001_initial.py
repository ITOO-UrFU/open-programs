    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('authors', models.ManyToManyField(blank=True, related_name='authors_courses', to='persons.Person', verbose_name='Автор')),
            ],
            options={
                'verbose_name': 'курс',
        ...
        migrations.AddField(
            model_name='course',
            name='sessions',
            field=models.ManyToManyField(blank=True, null=True, to='courses.Session', verbose_name='Сессии'),
        ),
        migrations.AddField(
            model_name='course',
            name='staff',
