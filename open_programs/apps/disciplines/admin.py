        ...
        document.addEventListener("DOMContentLoaded", function(event) {{
                var grid;
                  ...
                  var columns = [
                    ...
                    {{id: "1", name: "Нед. 1", field: "week1", resizable: true, width: 60, editor: Slick.Editors.IntegerEditor}},
                    {{id: "2", name: "Нед. 2", field: "week2", resizable: true, width: 60, editor: Slick.Editors.IntegerEditor}},
                    {{id: "3", name: "Нед. 3", field: "week3", resizable: true, width: 60, editor: Slick.Editors.IntegerEditor}},
                    {{id: "4", name: "Нед. 4", field: "week4", resizable: true, width: 60, editor: Slick.Editors.IntegerEditor}},
                    {{id: "5", name: "Нед. 5", field: "week5", resizable: true, width: 60, editor: Slick.Editors.IntegerEditor}},
                    {{id: "6", name: "Нед. 6", field: "week6", resizable: true, width: 60, editor: Slick.Editors.IntegerEditor}},
                    {{id: "7", name: "Нед. 7", field: "week7", resizable: true, width: 60, editor: Slick.Editors.IntegerEditor}},
                    {{id: "8", name: "Нед. 8", field: "week8", resizable: true, width: 60, editor: Slick.Editors.IntegerEditor}},
                    {{id: "9", name: "Нед. 9", field: "week9", resizable: true, width: 60, editor: Slick.Editors.IntegerEditor}},
                    {{id: "10", name: "Нед. 10", field: "week10", resizable: true, width: 60, editor: Slick.Editors.IntegerEditor}},
                    {{id: "11", name: "Нед. 11", field: "week11", resizable: true, width: 60, editor: Slick.Editors.IntegerEditor}},
                    {{id: "12", name: "Нед. 12", field: "week12", resizable: true, width: 60, editor: Slick.Editors.IntegerEditor}},
                    {{id: "13", name: "Нед. 13", field: "week13", resizable: true, width: 60, editor: Slick.Editors.IntegerEditor}},
                    {{id: "14", name: "Нед. 14", field: "week14", resizable: true, width: 60, editor: Slick.Editors.IntegerEditor}},
                    {{id: "15", name: "Нед. 15", field: "week15", resizable: true, width: 60, editor: Slick.Editors.IntegerEditor}},
                    {{id: "16", name: "Нед. 16", field: "week16", resizable: true, width: 60, editor: Slick.Editors.IntegerEditor}},
                    {{id: "17", name: "Нед. 17", field: "week17", resizable: true, width: 60, editor: Slick.Editors.IntegerEditor}},
                    {{id: "18", name: "Нед. 18", field: "week18", resizable: true, width: 60, editor: Slick.Editors.IntegerEditor}},
                    {{id: "19", name: "Нед. 19", field: "week19", resizable: true, width: 60, editor: Slick.Editors.IntegerEditor}},
                    {{id: "20", name: "Нед. 20", field: "week20", resizable: true, width: 60, editor: Slick.Editors.IntegerEditor}},
